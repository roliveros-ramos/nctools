...
within R. Its main entry point is
**[`write_ncdf()`](reference/write_ncdf.md)**, which offers a quick and
convenient way to write array data generated in R to netCDF files with
minimal boilerplate.
...
available in R. The function
**[`write_ncdf()`](reference/write_ncdf.md)** provides a simple
...
**[`write_ncdf()`](reference/write_ncdf.md)**, which makes it easy to
export array data created in R to a netCDF file.
